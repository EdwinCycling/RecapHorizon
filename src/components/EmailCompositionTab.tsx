        ...
        <div className="bg-blue-50 dark:bg-slate-800 rounded-lg border border-blue-200 dark:border-slate-700 p-4">
          ...
          <div className="space-y-3">
            {extractedEmails.map((extractedEmail, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-lg border border-blue-200 dark:border-slate-700 shadow-sm">
